...
#include "log.h"
#include <pthread.h>
#include <sys/stat.h> //该头文件用来支持mkdir()函数
using namespace std;
...
bool Log::init(const char *file_name, int is_debug, int write_log, int log_buf_size, int split_lines, int max_queue_size)
{
    ...
    //p == NULL的话，说明没有找到斜杠，默认为当前目录，就无需检查目录是否存在了\n");
